 ...
 */
/**
 * @typedef {Object} TablaRegistroActividadesProps
 * @property {EntradaLog[]} entries
 * @property {'producto'|'pedido'} modo
 */

/**
 * @param {TablaRegistroActividadesProps} props
 */
const TablaRegistroActividades = ({ entries, modo }) => {
  const headers =
    modo === 'producto'
...
export default TablaRegistroActividades;
